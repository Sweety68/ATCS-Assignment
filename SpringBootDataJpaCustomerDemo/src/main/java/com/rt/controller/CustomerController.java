...
public class CustomerController {
	...
	@GetMapping("/getCustomer/{cid}")        //  http://localhost:5678/customer/getCustomer/cid
	...
	@GetMapping("/getAllCustomers")          //  http://localhost:5678/customer/getAllCustomers
	...
	@DeleteMapping("/deleteCustomer/{cid}")      //  http://localhost:5678/customer/deleteCustomer/eid
